...
>(({ className, align = "start", sideOffset = 8, ...props }, ref) => {
  ...
  return <PopoverPrimitive.Portal container={container ?? undefined}>
    <PopoverPrimitive.Content
      ...
      className={cn(
        "z-50 max-h-[var(--radix-popover-content-available-height)] w-80 max-w-[calc(100vw-1rem)] overflow-y-auto overscroll-contain motion-reduce:animate-none rounded-2xl border border-carbon/10 bg-paper p-3 text-carbon shadow-[0_24px_64px_rgba(29,29,27,0.18)] outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        className
      )}
      {...props}
    />
