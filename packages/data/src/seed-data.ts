...
export const missions: TlozMission[] = [
  ...
  },
  {
    ...
    description: "Pendiente: el mock actual solo filtra localmente; falta command/search global.",
    descriptionDetail: "Alinear cómo búsqueda abre Missions, Projects, Inventory y Recursos desde una sola entrada.",
    icon: "Search",
  ...
  },
  {
    ...
    description: "La guía base queda en español con Main Quest, Side Quest, Farming Quest, Exploration Quest e Inventory en English.",
    descriptionDetail: "Normalizar español de UI y conservar términos RPG en English.",
    icon: "Copy",
    type: "side_quest",
    status: "completed",
    ownerId: "owner",
