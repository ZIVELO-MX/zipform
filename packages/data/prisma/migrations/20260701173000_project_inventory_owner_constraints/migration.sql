...
INSERT INTO "new_tloz_projects" SELECT "id", "name", "description", "color", "icon", "status", "type", "ownerId", "startDate", "dueDate", "createdAt", "updatedAt" FROM "tloz_projects";
...
INSERT INTO "new_tloz_quest_items" SELECT "id", "name", "description", "icon", "status", "category", "ownerId", "acquiredAt", "createdAt", "updatedAt" FROM "tloz_quest_items";
