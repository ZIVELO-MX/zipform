...
export function TableClient({ missions, statusOptions = [] }: { missions: TlozMissionRecord[]; statusOptions?: TlozFieldOption[] }) {
  ...
  return (
    <>
      <MissionTable missions={missions} statusOptions={statusOptions} onSelect={handleSelect} />
